...
export default function FinalCTA() {
  ...
  function copyRefLink() {
    ...
    trackEvent("waitlist_referral_link_copied", { source: "final_cta" });
    setCopied(true);
  ...
  return (
    <section className="py-32 bg-background text-center relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <h2 className="text-4xl lg:text-6xl font-semibold text-foreground mb-5 tracking-tight leading-tight">
        ...
        <p className="text-xl text-muted-foreground mb-10 font-light max-w-lg mx-auto leading-relaxed">
          ...
          <div className="max-w-md mx-auto">
            ...
            >
              <input
                ...
                required
                className="flex-1 px-5 py-4 rounded-2xl bg-muted/50 border border-border text-foreground placeholder-zinc-500 text-base outline-none focus:border-indigo-500/50 focus:bg-border/60 transition-all"
              />
              <button
                type="submit"
            ...
            <div className="flex items-center justify-center gap-3 mt-4">
              {total !== null && total > 0 && (
                <div className="flex items-center gap-1.5 text-sm text-muted-foreground">
                  ...
                  {/* <span>Join <span className="text-foreground/80 font-medium">{total.toLocaleString()}+</span> on the waitlist</span> */}
                </div>
              )}
            </div>
          </div>
        ) : (
          <div className="max-w-md mx-auto rounded-2xl bg-muted/40 border border-border p-6 space-y-4 text-left">
