...
const useCases = [
    {
        persona: "Founder",
        before: "45 min every morning triaging email, Slack, and Linear before any real work started.",
        after: "Morning brief delivered at 6:47am. 4 replies drafted, 3 tickets updated, Slack digest ready. Day starts in 5 minutes.",
        app: "Gmail · Slack · Linear",
    },
    {
        persona: "Sales rep",
        before: "Manually logging every call and email into HubSpot at end of day. Always a day behind.",
        after: "CalmPilot logs each call and email to the right contact automatically. CRM is live, not lagging.",
        app: "Gmail · HubSpot · Calendar",
    },
    {
        persona: "Engineer",
        before: "Copying GitHub issue context into Slack and Notion every sprint. Same information, three places.",
        after: "New GitHub issues auto-post to the team channel and create Notion entries with full context attached.",
...
export default function SocialProof() {
    ...
    const stats = [
        {
            value: waitlistCount ? `${waitlistCount.toLocaleString()}+` : "2,400+",
        ...
        <section className="bg-black border-y border-white/[0.06] py-16">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-px bg-white/[0.05] rounded-2xl overflow-hidden border border-white/[0.05]"
                >
                    {stats.map((s, i) => (
