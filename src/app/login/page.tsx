    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg-deep)]">
      <div className="w-full max-w-sm text-center space-y-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-6 py-3.5 rounded-xl bg-[var(--bg-surface)] border border-[var(--border)] text-[var(--text-primary)] text-sm font-medium hover:bg-[var(--accent-soft)] transition-all"
        >
