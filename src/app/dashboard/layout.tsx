  ...
  if (balance <= 0) {
    return (
      <div className="sticky top-0 z-50 flex items-center justify-between gap-3 px-4 py-2.5 bg-red-500/10 border-b border-red-500/20 dark:border-red-500/30 text-red-600 dark:text-red-400 text-sm font-medium">
        ...
        <Link href="/dashboard/settings" className="shrink-0 px-3 py-1 rounded-lg bg-red-500/10 hover:bg-red-500/20 dark:bg-red-500/20 dark:hover:bg-red-500/30 text-red-700 dark:text-red-300 text-xs font-semibold transition-colors">
          Add Credits →
        </Link>
      </div>
    );
  ...
  if (balance < 1.00) {
    return (
      <div className="sticky top-0 z-50 flex items-center justify-between gap-3 px-4 py-2.5 bg-amber-500/10 border-b border-amber-500/20 dark:border-amber-500/30 text-amber-600 dark:text-amber-400 text-sm font-medium">
        ...
        <Link href="/dashboard/settings" className="shrink-0 px-3 py-1 rounded-lg bg-amber-500/10 hover:bg-amber-500/20 dark:bg-amber-500/20 dark:hover:bg-amber-500/30 text-amber-700 dark:text-amber-300 text-xs font-semibold transition-colors">
          Add Credits →
        </Link>
      </div>
    );
