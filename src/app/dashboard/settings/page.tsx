        ...
        <div className="space-y-6">
          ...
          <section className="bg-[var(--bg-elevated)] border border-[rgba(255,255,255,0.02)] rounded-3xl p-8 shadow-sm">
            ...
            <p className="text-sm text-[var(--text-muted)] font-medium mb-6">
              Choose the intelligence engine that powers your assistant
            </p>
          ...
          <Link href="/dashboard/usage" className="block">
            <section className="bg-[var(--bg-elevated)] border border-[rgba(255,255,255,0.02)] rounded-3xl p-8 hover:bg-[rgba(255,255,255,0.02)] transition-colors cursor-pointer group shadow-sm">
