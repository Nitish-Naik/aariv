...
export const PLATFORM_LOGOS: Record<string, string> = {
  ...
  jira:
    "data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'%3E%3Cpath fill='%232684FF' d='M11.53 2c0 4.97-4.03 9-9 9h-.03a9 9 0 009 9 9 9 0 009-9c0-4.97-4.03-9-9-9h.03z'/%3E%3C/svg%3E",
  dropbox:
